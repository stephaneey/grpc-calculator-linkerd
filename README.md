...
If you want to compare both implementations, I also published [the corresponding rest calculator app](https://github.com/stephaneey/rest-calculator-linkerd). 
